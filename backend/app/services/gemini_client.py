...
def analyze_card_image(image_path: str) -> str:
    prompt = (
        "You are an expert card color analyst. Read the card text from the image and output JSON in the format: "
        '{"cards": [{"index": <number>, "color": "<color>", "keyword_primary": "<keyword>", '
        '"keyword_secondary": "<keyword>", "score": <number>}]} '
        "Use null for any field that cannot be recognized."
    )
...
if __name__ == "__main__":
    ...
    demo_prompt = "Please parse the content of this card and output a concise English summary."
    try:
